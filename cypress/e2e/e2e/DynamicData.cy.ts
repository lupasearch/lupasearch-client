...
describe('DynamicData', () => {
  ...
  it('should display regular price element once it is loaded', () => {
    cy.get(searchResultsRegularPrice).should('exist').last().should('contain.text', '50,00 €')
  })
  ...
  it('should render dynamic data after a page change', () => {
    ...
    cy.get(searchResultsRegularPrice).should('exist').last().should('contain.text', '30,00 €')
  })
})
