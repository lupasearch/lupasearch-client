...
import { searchResultsProducts } from "../../fields/SearchResults.fields.spec";
...
describe("SearchBox", () => {
  ...
  it("should not navigate to result page if search input is too short", () => {
    ...
    cy.get(searchResultsProducts).should("not.exist");
  });
  ...
  it("should navigate to result page if search input is longer than configured min length", () => {
    ...
    cy.get(searchResultsProducts).should("exist");
  });
